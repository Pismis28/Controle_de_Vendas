...
namespace Controle_de_vendas.Controllers
{
    public class AdministradorsController : Controller
    {
        ...
        public AdministradorsController(Controle_de_vendasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AdministradorId,Acesso,Produto,Quantidade,Valor")] Administrador administrador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AdministradorId,Acesso,Produto,Quantidade,Valor")] Administrador administrador)
        {
