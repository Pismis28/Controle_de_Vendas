...
namespace Controle_de_vendas.Controllers
{
    public class VendedorsController : Controller
    {
        ...
        public VendedorsController(Controle_de_vendasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("VendedorID,VendedorName,VendedorSobrenome,CPF,Telefone,Email")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VendedorID,VendedorName,VendedorSobrenome,CPF,Telefone,Email")] Vendedor vendedor)
        {
